...
Map to output will remove 'Input' from service output if a capture is not specified.

'NextState' must be a subset of capture of 'CurrentState', and becomes 'CurrentState' in next run of service - it always has 'Input' as first item.
